...
{
System.setProperty("webdriver.chrome.driver", "D:\\Selenium10\\MAVEN_ERP1\\CommonDrivers\\chromedriver.exe");
driver=new ChromeDriver();
}
else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
{
System.setProperty("webdriver.gecko.driver", "D:\\Selenium10\\MAVEN_ERP1\\CommonDrivers\\geckodriver.exe");
...
FileWriter fw=new FileWriter("D:\\Selenium10\\MAVEN_ERP1\\CaptureData\\supplier.txt");
...
{
FileReader fr=new FileReader("D:\\Selenium10\\MAVEN_ERP1\\CaptureData\\supplier.txt");
